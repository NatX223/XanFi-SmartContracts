...
// interface IFund {
//     function sale(uint256 userSupply, uint256 fundTotalSupply, address tokenAddress, address receiver) external;
// }
...
//     function crossChainRedeem(uint256 _totalSupply, address _targetIndex, uint256 _userBalance, address _assetContract, uint16 targetChain) public payable {
//         uint256 cost = quoteCrossChainMessage(targetChain);
//         require(msg.value == cost, "not enough gas");
//         wormholeRelayer.sendPayloadToEvm{value: cost}(
//             targetChain,
//             routerAddresses[targetChain],
//             abi.encode(_totalSupply, _assetContract, _userBalance, _targetIndex), // payload
//             0,
//             GAS_LIMIT
//         );
//     }
...
//         (uint256 totalSupply, address assetContract, uint256 userSupply, address targetIndex, address receiver) = abi.decode(
//             payload,
//             (uint256, address, uint256, address, address)
//         );
//         IFund(targetIndex).sale(userSupply, totalSupply, assetContract, receiver);
//     }
