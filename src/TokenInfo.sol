...
contract Index is TokenSender, TokenReceiver {
    uint256 constant GAS_LIMIT = 300_000;

    address public tokenPurchase;
    ...
    function sendCrossChainDeposit(
        ...
        bytes memory payload = abi.encode(recipient, purchaseToken);
    ...
    function receivePayloadAndTokens(
        ...
        (address recipient, address purchaseToken) = abi.decode(payload, (address, address));
